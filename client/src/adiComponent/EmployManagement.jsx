...
const EmployeeManagement = () => {
  ...
  const isEmailTaken = async (email) => {
    try {
      const response = await axios.get(
        "https://crmdemo.vimubds5.a2hosted.com/api/checkEmail",
        {
          params: { email },
        }
      );
  ...
  const filteredEmployees = employees.filter((employee) => {
    ...
    return (
      ...
      employee.phone.includes(lowercasedQuery)
    );
  });
  ...
  return (
    <>
      ...
      <div className="container mt-12 flex flex-col min-h-screen lg:flex-row">
        <main className="flex-1 justify-between p-4 lg:p-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8 space-y-4 lg:space-y-0">
            ...
            <input
              ...
              className="w-full lg:w-auto p-2 border rounded-lg border-gray-300"
            />
            ...
            <button
              ...
              className="flex items-center justify-center w-full lg:w-auto px-4 py-2 font-medium text-white bg-blue-500 rounded-lg shadow-lg hover:bg-blue-600 transition duration-200"
            >
